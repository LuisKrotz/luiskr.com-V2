<template>
    <div>
        ...
        <img v-if="open" :src="storage + 'glitches/'+ random + '.gif'" class="hover" :style="'transform: translate(' + page.left + 'px, ' + page.top + 'px); '+ (showhover ? 'visibility: visible; opacity: 1' : 'visibility: hidden: opacity: 0')" aria-hidden="true">
    </div>
</template>
