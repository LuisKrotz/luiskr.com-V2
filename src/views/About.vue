    ...
    <main class="max-area">
        <article>
          <div class="about main">
            <h2 class="main-title" @click="sendAnalyticsEvent('about_link', 'click','home', 100)"><router-link to="/">luiskr</router-link></h2>
            <h3 class="main-subtitle">About Me</h3>
            <p class="main-text">I'm a Frond-End Developer currently working full time at <a @click="sendAnalyticsEvent('about_link', 'click','transainc', 100)" href="https://www.instagram.com/transainc_" rel="noopener">transainc</a>. Living in Porto Alegre / Brazil, and a part-time Freelancer.<br>
