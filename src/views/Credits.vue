    ...
    <main class="max-area credits">
        <article>
          <div class="about main">
            <h2 class="main-title" v-view>Credits</h2>
            <h3 class="main-subtitle" v-view>Thanks</h3>
            <p class="main-text" v-view><span>Special thanks for everyone that makes the web a better place by sharing resources. In this page, are listed the main technologies used to build this website and resource sources.</span></p>
            ...
            <p class="main-text" v-view><span>All gifs used on this project can be found at: <a target="_blank" rel="noopener" @click="sendAnalyticsEvent('credits_link', 'click', 'GIPHY', 50)" href="https://giphy.com">GYPHY.COM</a> and all the credits of them are of it's creators.</span></p>
          </div>
      </article>
    </main>
</div>
