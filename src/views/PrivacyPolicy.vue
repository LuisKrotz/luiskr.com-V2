  ...
  <div class="footer-open">
    <main class="max-area">
      <article class="about main">
        ...
        <h3 class="main-subtitle">Information I collect</h3>
        <p class="main-text">The personal information that you are asked to provide, and the reasons why you are asked to provide it, will be made clear to you at the point I ask you to provide your personal information.</p>
        <p class="main-text">If you contact me directly, I may receive additional information about you such as your name, email address, phone number, the contents of the message and/or attachments you may send us, and any other information you may choose to provide.</p>

        <h3 class="main-subtitle">How I use your information</h3>
        <p class="main-text">I use the information I collect in various ways, including to:
          <ol>
        ...
        <p class="main-text">Under the CCPA, among other rights, California consumers have the right to:</p>
        <p class="main-text">Request that a business that collects a consumer's personal data disclose the categories and specific pieces of personal data that a business has collected about consumers.</p>
        <p class="main-text">Request that a business delete any personal data about the consumer that a business has collected.</p>
        <p class="main-text">Request that a business that sells a consumer's personal data, not sell the consumer's personal data.</p>
        <p class="main-text">If you make a request, I have one month to respond to you. If you would like to exercise any of these rights, please contact me.</p>
